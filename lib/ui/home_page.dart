...
import 'package:technical_challange/bloc/product_bloc.dart';
      ...
      child: Padding(
        ...
        child: BlocProvider<ProductBloc>(
          ...
          child:
            ...
            if (state is SuccesGetProductState) {
                ...
                children: [
                  AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                        boxShadow:  [
                          (_selectedFeatures==0)?BoxShadow(
                              color: ColorsValue.black100.withOpacity(0.35),
                              spreadRadius: 0.1,
                              blurRadius: 3,
                              offset: const Offset(0, 5)):const BoxShadow(color: Colors.white)
                        ],
                ...
                children: [
                  ClipRRect(
                    ...
                    child: SizedBox(
                      ...
                      child: Image.network(
                          Url.host +
                              '/storage/product_images/${products[index].image}',
                          fit: BoxFit.fill),
                    ),
                  ),
                  const SizedBox(
